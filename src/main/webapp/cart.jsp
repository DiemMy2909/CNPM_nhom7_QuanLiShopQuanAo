...
//    Map<Product, Integer> list = dao.getCart((String) session.getAttribute("username"));
////    List<Product> list = dao.getCart((String) session.getAttribute("username"));
                    ...
                    <div class="row">
                                ...
                                <tr>
                                    ...
                                    <td class="quantity-col">
                                        <div class="cart-product-quantity">
                                            <input type="number" class="form-control" value="<%=p.getSoluong()%>" min="1" max="10"
                                                   step="1" data-decimals="0" required>
                                        </div><!-- End .cart-product-quantity -->
                                    </td>
                                    <td class="total-col"> <%=p.getSoluong()*p.getPrice()%> </td>
                                    <td class="remove-col">
                        ...
                        <aside class="col-lg-3">
                            <div class="summary summary-cart">
                                ...
                                <a href="CheckSessionPayController"
                                   class="btn btn-outline-prFimary-2 btn-order btn-block">TIẾN HÀNH THANH TOÁN</a>
                            </div><!-- End .summary -->
